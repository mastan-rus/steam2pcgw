...
|directinput controllers       = unknown
|directinput controllers notes = 
|directinput prompts           = unknown
...
|nintendo controllers          = unknown
|nintendo controller models    = 
|nintendo controllers notes    = 
|nintendo prompts              = unknown
|nintendo prompts notes        = 
|nintendo button layout        = unknown
|nintendo button layout notes  = 
|nintendo motion sensors       = unknown
